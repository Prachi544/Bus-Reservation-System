//BROUGHT TO YOU BY VINOD SHARMA//
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Bhardwaj Express","Arjun Travels","Dheeraj Express","PK Express","Indian Express","Harayan Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
getch();
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t Brought To You By Vinod Sharma");
    getch();
    return 0;
}
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword);
		if(strcmp(uname,"vinod")==0 && strcmp(pword,"vinod")==0)
	{
